...
uploaded_file = st.sidebar.file_uploader("Choose an image...", type=["jpg", "jpeg", "png"], key="file_uploader")
...
with col2:
    st.header("Chat")
    user_input = st.text_input("Ask a question or type your message...", key="user_input", on_change=handle_text_submission)
